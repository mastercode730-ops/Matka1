    ...
    <div id="wrapper">
      ...
      {heroGame && (
        <div className="lrs">
          ...
          <span className="lrs-num">
            {!heroGame.today_number ||
            heroGame.today_number === "XX" ||
            heroGame.today_number === "--"
              ? "??"
              : heroGame.today_number}
          </span>
      ...
      <header className="topbar">
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          >
            <span
              className="lrs-dot"
              style={{ background: syncing ? "#ffb020" : "#ffffff" }}
            />
            {syncing ? "सिंक..." : "लाइव 🔴"}
          </a>
        </div>
        ...
        <section className="hero">
          <div className="hero-inner">
            ...
            <p className="hero-hindi">
              हाँ भाई, सबसे पहले खबर यहीं आती है &bull; {SITE_DOMAIN}
            </p>
          ...
          >
            <path
              fill="#ffffff"
              d="M0,40 C240,80 480,0 720,25 C960,50 1200,80 1440,45 L1440,70 L0,70 Z"
            />
          </svg>
        </section>
      )}
      ...
      <div className="wrap">
        ...
        <div className="wa-wave-banner">
          <div>
            <div className="wa-wave-title">
              👑 सीधा खाईवाल से संपर्क करें &bull; 100% ईमानदार सट्टा सर्विस
            </div>
            <div className="wa-wave-sub">
              लीक सिंगल जोड़ी और हरूफ प्राप्त करने के लिए WhatsApp करें:{" "}
              {WHATSAPP_NUMBER}
            </div>
          </div>
          <a
        ...
        <section id="results">
          ...
          <p className="section-sub">
            सबसे तेज़ और सटीक परिणाम तालिका &bull; 15 सेकंड ऑटो-रिफ्रेश
          </p>
                  ...
                  return (
                    <tr key={g.code}>
                      ...
                      <td className="cell-today">
                        <span
                          className={`today-num ${isPending ? "wait" : ""}`}
                        >
        ...
        <section id="monthly-chart">
          ...
          <p className="section-sub">
            सभी 4 मुख्य गेम (DESAWAR, FARIDABAD, GHAZIABAD, GALI) का संयुक्त
            मासिक चार्ट
          </p>
