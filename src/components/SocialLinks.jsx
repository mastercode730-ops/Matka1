...
const SocialLinks = () => {
  return (
    <div className="bg-[#ffcc00] border-2 border-[#006400] rounded-[15px] p-2.5 mx-auto my-[15px] w-[85%] text-center shadow-[0_4px_10px_rgba(0,0,0,0.2)]">
      ...
      <a href="https://wa.me/917589045547" className="inline-flex items-center justify-center py-[1px] px-[10px] rounded-[50px] no-underline border-2 border-[#ff0000] transition-all duration-300 min-w-[180px] bg-[#0088cc] text-white mt-2">
