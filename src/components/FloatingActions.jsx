...
const FloatingActions = () => (
  <>
    ...
    <div className="fixed bottom-[150px] w-full pointer-events-none z-[99999] flex justify-between px-[15px]">
      <a href="https://wa.me/917589045547" className="pointer-events-auto w-[50px] h-[50px] rounded-full flex items-center justify-center text-center no-underline shadow-[0_4px_15px_rgba(0,0,0,0.5)] border-[3px] border-white transition-transform duration-300 active:scale-90 bg-[radial-gradient(circle,gold,#ff9900)] text-black">
